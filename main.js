...
const app = {
    ...
    songs: [
        { 
            name: 'Dalatmango',
            singer: 'PC',
            path: '/JS_Product/Music_Player/Music/dalatmango.mp3',
            image: '/JS_Product/Music_Player/Pics/dalatmango.jpg'  
        },
        { 
            name: 'Mây Lang Thang',
            singer: 'Tùng TeA & PC',
            path: '/JS_Product/Music_Player/Music/maylangthang.mp3',
            image: '/JS_Product/Music_Player/Pics/maylangthang.jpg'  
        },
        { 
            name: 'Phiêu Bồng',
            singer: 'Tofu',
            path: '/JS_Product/Music_Player/Music/phieubong.mp3',
            image: '/JS_Product/Music_Player/Pics/phieubong.jpg'  
        },
        { 
            name: 'Ánh Chiều',
            singer: 'DICK ft XÁM',
            path: '/JS_Product/Music_Player/Music/anhchieu.mp3',
            image: '/JS_Product/Music_Player/Pics/anhchieu.jpg'  
        },
        { 
            name: 'Có Hạt Sương Trên Mắt Em',
            singer: 'NHA x DICK x XÁM',
            path: '/JS_Product/Music_Player/Music/cohatsuongtrenmatem.mp3',
            image: '/JS_Product/Music_Player/Pics/cohatsuongtrenmatem.jpg'  
        },
        { 
            name: 'Hometown',
            singer: 'Sol7 x LDleKING',
            path: '/JS_Product/Music_Player/Music/hometown.mp3',
            image: '/JS_Product/Music_Player/Pics/hometown.jpg'  
        },
        { 
            name: 'Side Effects',
            singer: 'Rhymastic & B-Wine',
            path: '/JS_Product/Music_Player/Music/sideeffects.mp3',
            image: '/JS_Product/Music_Player/Pics/sideeffects.jpg'  
        },
        { 
            name: 'Raindrop',
            singer: 'Sol7 x Pjnboys',
            path: '/JS_Product/Music_Player/Music/raindrop.mp3',
            image: '/JS_Product/Music_Player/Pics/raindrop.jpg'  
        },
        { 
            name: 'Slow Down',
            singer: 'Seachains ft Summer Vee',
            path: '/JS_Product/Music_Player/Music/slowdown.mp3',
            image: '/JS_Product/Music_Player/Pics/slowdown.jpg'  
        },
        { 
            name: 'An Thần',
            singer: 'Low G ft Thắng',
            path: '/JS_Product/Music_Player/Music/anthan.mp3',
            image: '/JS_Product/Music_Player/Pics/anthan.jpg'  
        },
        { 
            name: 'Đi Qua Mùa Hạ',
            singer: 'Thái Đinh',
            path: '/JS_Product/Music_Player/Music/diquamuaha.mp3',
            image: '/JS_Product/Music_Player/Pics/diquamuaha.jpg'  
        },
        { 
            name: 'MAI VỀ',
            singer: 'Dfoxie37 x Myhai',
            path: '/JS_Product/Music_Player/Music/maive.mp3',
            image: '/JS_Product/Music_Player/Pics/maive.jpg'  
        },
        { 
            name: '23:40',
            singer: 'Hào',
            path: '/JS_Product/Music_Player/Music/2340.mp3',
            image: '/JS_Product/Music_Player/Pics/2340.jpg'  
        },
        { 
            name: 'baby gudnite',
            singer: 'willistic',
            path: '/JS_Product/Music_Player/Music/babygudnite.mp3',
            image: '/JS_Product/Music_Player/Pics/babygudnite.jpg'  
        },
        { 
            name: 'Dự Báo Thời Tiết Hôm Nay Mưa',
            singer: 'GREY D',
            path: '/JS_Product/Music_Player/Music/dubaothoitiethomnaymua.mp3',
            image: '/JS_Product/Music_Player/Pics/dubaothoitiethomnaymua.jpg'  
        },
        { 
            name: 'Chết Trong Em',
            singer: 'Thịnh Suy',
            path: '/JS_Product/Music_Player/Music/chettrongem.mp3',
            image: '/JS_Product/Music_Player/Pics/chettrongem.jpg'  
        },
        { 
            name: 'Lộn Xộn ll',
            singer: 'Đen',
            path: '/JS_Product/Music_Player/Music/lonxon2.mp3',
            image: '/JS_Product/Music_Player/Pics/lonxon2.jpg'  
        },
        { 
            name: 'Mười Năm',
            singer: 'Đen ft Ngọc Linh',
            path: '/JS_Product/Music_Player/Music/muoinam.mp3',
            image: '/JS_Product/Music_Player/Pics/muoinam.jpg'  
        },
        { 
            name: 'Một Triệu Like',
            singer: 'Đen ft Thành Đồng',
            path: '/JS_Product/Music_Player/Music/mottrieulike.mp3',
            image: '/JS_Product/Music_Player/Pics/mottrieulike.jpg'  
        },
        { 
            name: 'Thanh Xuân',
            singer: 'Da LAB',
            path: '/JS_Product/Music_Player/Music/thanhxuan.mp3',
            image: '/JS_Product/Music_Player/Pics/thanhxuan.jpg'  
        },
        { 
            name: 'Cô Gái Bàn Bên',
            singer: 'Đen ft Lynk Lee',
            path: '/JS_Product/Music_Player/Music/cogaibanben.mp3',
            image: '/JS_Product/Music_Player/Pics/cogaibanben.jpg'  
        },
        { 
            name: 'Bài Này Chill Phết',
            singer: 'Đen ft. MIN',
            path: '/JS_Product/Music_Player/Music/bainaychillphet.mp3',
            image: '/JS_Product/Music_Player/Pics/bainaychillphet.jpg'  
        },
        { 
            name: 'TRƯỚC KHI TUỔI TRẺ NÀY ĐÓNG LỐI',
            singer: 'Ngắn x Xám x Dick',
            path: '/JS_Product/Music_Player/Music/truockhituoitrenaydongloi.mp3',
            image: '/JS_Product/Music_Player/Pics/truockhituoitrenaydongloi.jpg'  
        },
        { 
            name: 'Có Em',
            singer: 'Madihu ft Low G',
            path: '/JS_Product/Music_Player/Music/coem.mp3',
            image: '/JS_Product/Music_Player/Pics/coem.jpg'  
        },
        { 
            name: 'Cứ Chill Thôi',
            singer: 'Chillies',
            path: '/JS_Product/Music_Player/Music/cuchillthoi.mp3',
            image: '/JS_Product/Music_Player/Pics/cuchillthoi.jpg'  
        },
        { 
            name: 'Treasure',
            singer: 'Rhymastic',
            path: '/JS_Product/Music_Player/Music/treasure.mp3',
            image: '/JS_Product/Music_Player/Pics/treasure.jpg'  
        },
        { 
            name: 'Khi Màn Hình Tắt',
            singer: 'Rhymastic',
            path: '/JS_Product/Music_Player/Music/khimanhinhtat.mp3',
            image: '/JS_Product/Music_Player/Pics/khimanhinhtat.jpg'  
        },
        { 
            name: 'LẠC',
            singer: 'Rhymastic',
            path: '/JS_Product/Music_Player/Music/lac.mp3',
            image: '/JS_Product/Music_Player/Pics/lac.jpg'  
        },
        { 
            name: 'LUX',
            singer: 'KOO ft NGUYÊN',
            path: '/JS_Product/Music_Player/Music/lux.mp3',
            image: '/JS_Product/Music_Player/Pics/lux.jpg'  
        },
        { 
            name: 'AI BIET',
            singer: 'WEAN',
            path: '/JS_Product/Music_Player/Music/aibiet.mp3',
            image: '/JS_Product/Music_Player/Pics/aibiet.jpg'  
        },
        { 
            name: 'mot nguoi vi em (midnight)',
            singer: 'WEAN',
            path: '/JS_Product/Music_Player/Music/motnguoiviem.mp3',
            image: '/JS_Product/Music_Player/Pics/motnguoiviem.jpg'  
        },
    ],
